...
export const QUSETION_INFO1: string = '열람인이 반드시 알만한 답변으로 구성해주세요';
export const QUSETION_INFO2: string = '명확하게 정답이 있는 질문으로 만들어주세요';
export const QUSETION_INFO3: string = '10자 이내로 답변할 수 있는 질문으로 만들어주세요';
